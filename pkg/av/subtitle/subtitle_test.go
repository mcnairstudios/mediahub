...
func TestWriter(t *testing.T) {
	w := NewWriter()
	w.AddCue(1_000_000_000, 3_000_000_000, "Hello")
	w.AddCue(5_000_000_000, 3_500_000_000, "World")
...
func TestWriterCueCount(t *testing.T) {
	w := NewWriter()
	if w.CueCount() != 0 {
		t.Fatal("expected 0 cues")
	}
	w.AddCue(0, 1_000_000_000, "test")
	if w.CueCount() != 1 {
		t.Fatal("expected 1 cue")
	}
}
