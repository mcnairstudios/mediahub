...
var (
	cachedCapabilities     *platformCapabilities
	cachedCapabilitiesOnce sync.Once
)

func probeCapabilities() *platformCapabilities {
	cachedCapabilitiesOnce.Do(func() {
		...
		maxBitDepth := probeMaxBitDepthFromPlatforms(availablePlatforms)
...
func probeMaxBitDepthFromPlatforms(platforms map[string]bool) int {
