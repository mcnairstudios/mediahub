...
func (s *Server) registerRoutes() {
	...
	s.mux.Handle("GET /api/epg/series", s.authenticated(s.handleEPGSeries))
	...
	s.mux.Handle("GET /api/dashboard/stats", s.adminOnly(s.handleDashboardStats))
	...
	s.mux.HandleFunc("OPTIONS /api/play/{streamID}/webrtc/{path...}", s.handleCORSPreflight)
	...
	s.mux.Handle("DELETE /api/sources/trailers/{id}", s.adminOnly(s.handleDeleteTrailersSource))
	s.mux.Handle("POST /api/sources/demo", s.adminOnly(s.handleCreateDemoSource))
	s.mux.Handle("PUT /api/sources/demo/{id}", s.adminOnly(s.handleUpdateDemoSource))
	s.mux.Handle("DELETE /api/sources/demo/{id}", s.adminOnly(s.handleDeleteDemoSource))
	s.mux.Handle("POST /api/sources/spacex", s.adminOnly(s.handleCreateSpaceXSource))
	s.mux.Handle("PUT /api/sources/spacex/{id}", s.adminOnly(s.handleUpdateSpaceXSource))
	s.mux.Handle("DELETE /api/sources/spacex/{id}", s.adminOnly(s.handleDeleteSpaceXSource))
	s.mux.Handle("POST /api/sources/radiogarden", s.adminOnly(s.handleCreateRadioGardenSource))
