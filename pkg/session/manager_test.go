...
func (s *stubPlugin) PushVideo(data []byte, pts, dts, duration int64, keyframe bool) error { return nil }
func (s *stubPlugin) PushAudio(data []byte, pts, dts, duration int64) error                { return nil }
