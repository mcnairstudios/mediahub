...
try {
  ...
  if (exported && exported.pages) {
    ...
    var expected = ['dashboard', 'streams', 'channels', 'library', 'guide', 'recordings', 'favorites', 'activity', 'sources', 'sourceprofiles', 'epgsources', 'wireguard', 'settings', 'users', 'clients', 'logos', 'tmdb', 'probe', 'player', 'hdhrdevices', 'invites', 'apikeys'];
